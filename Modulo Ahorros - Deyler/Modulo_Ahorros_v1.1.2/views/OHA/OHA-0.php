                    ...
                    <div class="row">
                        <div class="form-group col-md-6">
                            <div class="input-group">
                                ...
                                <select class="form-select-group col-md-4" id="tipCuent" placeholder="" requiered aria-label="Default select example">
                    ...
                    <div class="row">
                         <div class="form-group col-md-3">
                            <div class="input-group">
                                ...
                                <input type="number"  requiered class="form-control" id="nit" placeholder="">
                            </div>                                                                                
                        </div>    
                    ...
                    <div class="row">
                         <div class="form-group col-md-3">
                            <div class="input-group">
                                ...
                                <input type="text" aria-label="Cliente" id="client" class="form-control col" placeholder="" requiered >
                            </div>            
                        </div>                                                                            
                        <div class="form-group">
                            <button class="btn btn-outline-secondary" type="button" id="button-addon1">
                    ...
                    <div class="row">
                        <div class="form-group col-md-3">
                            <div class="input-group">    
                                ...
                                <input type="text" class="form-control" id="names" readonly placeholder="" requiered >                                
                            </div>
                        </div> 
                    </div>
<!--Aho_0_ApertCuenAhor Préstamo-->
                    <div class="row">                                   
                        <div class="form-group col-md-3">
                            <div class="input-group">
                                <span class="input-group-addon">Préstamo</span>
                                <select class="form-select-group-addon col-12" id="prest" placeholder="" requiered aria-label="Default select example" readonly>
                                    <option selected>Open this select menu</option>
                                    <option value="1">One</option>
                                    <option value="2">Two</option>
                                    <option value="3">Three</option>
                    ...
                    <div class="row">   
                        <div class="form-group col-md-3">
                            <div class="input-group">    
                                ...
                                <input type="date" placeholder="" requiered class="form-control col-10" id="dat" min="2022-01-01" value ="2022-01-31" readonly>                                
                            </div>
                        </div>   
                        <div class="form-group col-md-3">
                            <div class="input-group">
                                <span class="input-group-addon">Tasa %</span>
                                <input type="number" class="form-control col-5" id="tas" placeholder="0.00" readonly requiered>
                            </div>                                                                                
                        </div>   
                        <div class="form-group col-md-3">
                            <div class="input-group">
                                <span class="input-group-addon">Libreta</span>
                                <input type="number" class="form-control col-12" id="libr" placeholder="0.00" readonly requiered>
                            </div>                                                                                
                        </div>  
                    </div>
                    ...
                    <div class="row">
                         <div class="form-group col-md-3">
                            ...
                            <span class="input-group-addon">Cta. Ahorros</span>
                                <input type="number" class="form-control" id="ctaAhorro" placeholder="   -   -  -  " required>                                
                            </div>                                                                                
                        </div>    
                        <div class="form-group">
                            <button class="btn btn-outline-secondary" type="button" id="button-addon1">
...
<!--Aho_0_BeneAho Búsqueda Cliente-->       
                    <div class="row">
                         <div class="form-group col-md-3">
                            <div class="input-group">
                            <span class="input-group-addon">Cliente</span> 
                            <input type="text" aria-label="Cliente" id="client2" class="form-control col" placeholder="" requiered >
                            </div>                                                                                
                        </div>    
                        <div class="form-group">
                            <button class="btn btn-outline-secondary" type="button" id="button-addon1">
